...
export const MarkdownContent = memo(function MarkdownContent({
  ...
  return (
    <div
      className={cn(
        'prose prose-sm prose-neutral dark:prose-invert max-w-full min-w-0 wrap-break-word text-inherit',
        ...
        'prose-pre:max-w-full prose-pre:overflow-x-auto prose-pre:bg-muted/60 prose-pre:text-inherit prose-pre:code:text-inherit',
