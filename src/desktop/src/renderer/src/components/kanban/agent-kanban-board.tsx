...
export function AgentKanbanBoard(): React.JSX.Element {
  ...
  const columns = groupChatsByStatus(chats, { resolveStatus: resolveBoardStatus })
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      <PageHeader title="Agents" description="Live board — cards move as status updates arrive" />
