...
export type ChatMode = 'agent' | 'plan' | 'implement' | 'orchestrate' | 'goal' | 'participant'
...
export const CHAT_MODES: ChatModeOption[] = [
...

  {
    value: 'participant',
    label: 'Participant',
    description: 'Conversational member that fact-checks and helps the discussion'
  }
